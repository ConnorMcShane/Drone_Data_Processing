...
def create_labels(detectionsFolder, warpedFolder, imagesFolder, labelsFolder, bboxFolder, numberOfFrames, videoName, fps, segmentLengthSeconds, val_split, min_size = 2500, max_size = 100000):
